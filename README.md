# amigo-secreto-web
[Lista de Deseos-Amigo Secreto.html](https://github.com/user-attachments/files/23831903/Lista.de.Deseos-Amigo.Secreto.html)
<!DOCTYPE html>
<html lang="es">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Amigo Secreto 🎁 - Firebase</title>
...
<div class="section" id="groupSection">
  <h2>1. Crea o únete a un grupo</h2>
  <input type="text" id="groupCode" placeholder="Código de grupo (4 letras)">
  <input type="text" id="username" placeholder="Tu nombre">
  <button onclick="joinGroup()">Entrar</button>
  <p style="color:#ffd700; font-size:14px;">Comparte el código con tu familia para que todos se unan.</p>
</div>
...
<script>
// 🔹 Configuración de Firebase (tu snippet)
...
function joinGroup() {
  ...
  if(!username || !groupCode) return alert("Ingresa tu nombre y código");
